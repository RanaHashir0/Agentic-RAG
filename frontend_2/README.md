...
These handlers let the UI behave end-to-end without an external backend. To integrate a real service, replace the route implementations or point the front-end fetch calls inside `context/EnhancedChatContext.tsx` to your APIs.
...
- **State Management:** Conversation logic is contained in `context/EnhancedChatContext.tsx`. Extend it to connect real-time transports or persistence layers.
